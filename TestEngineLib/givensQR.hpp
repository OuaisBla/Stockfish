...
namespace mathalgo
{
	...
	public:
		...
		*/
		...
		{
			size_t nRows = oMatrix.rows();
			size_t nCols = oMatrix.cols();
	...
	private:
		...
		*/
		void PreMultiplyGivens( matrix<T>& oMatrix, size_t i, size_t j )
		{
			size_t nRowSize = oMatrix.cols();
